...
class MarkdownTopPage(MarkdownPage):
    ...
    def write_title(self, file_object: IO) -> None:
        ...
        file_object.write(rb"""{% if site.description %}{{ site.destination }}{% else %}This documentation is automatically generated by <a href="https://github.com/kmyk/online-judge-verify-helper">online-judge-verify-helper</a>."{% endif %}\n\n""")
